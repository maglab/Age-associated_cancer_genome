...
test_age_loss <- function(Unique.Name, project, purity, samples_to_exclude){
  ...
  write.csv(result, paste0("Analysis_results/CNAs/3_Age_biases_recurrent_SCNAs/Age_recurrent_focal_new/Multivariate_age_recurrent_focal_loss_exclude_normal_SCNAs/", project, "_multivariate_age_SCNA_", Name, "_exclude_normal_SCNAs.csv", collapse = ""), row.names = FALSE)
...
for(i in 1:nrow(loss_df)){
  ...
  tmp <- test_age_loss(Unique.Name = Unique.Name, project = project, purity = purity, samples_to_exclude = samples_to_exclude)
...
write.csv(result_df, "Analysis_results/CNAs/3_Age_biases_recurrent_SCNAs/Age_recurrent_focal_new/Multivariate_age_recurrent_focal_loss_exclude_normal_SCNAs.csv", row.names = FALSE)

# select only sig regions
result_df <- result_df[result_df$Sig == TRUE,]
write.csv(result_df, "Analysis_results/CNAs/3_Age_biases_recurrent_SCNAs/Age_recurrent_focal_new/Multivariate_age_recurrent_focal_loss_exclude_normal_SCNAs_sig.csv", row.names = FALSE)
