...
# write source data
write.csv(tmp_pathway_df_1, "Source_Data/Fig_5c_TP53.csv")
...
pdf(paste0("Analysis_results/Pathway_alterations/4_Heatmap_pathway/", project, "_pathway_heatmap_", pathway, ".pdf"), 
